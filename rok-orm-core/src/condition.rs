...
pub enum Condition {
    ...
    /// Full-text search match (PostgreSQL `col @@ to_tsquery(...)`, SQLite `col MATCH ?`).
    FullTextMatch {
        col: String,
        query: String,
        config: Option<String>,
    },
    /// Full-text search rank expression (renders as `ts_rank(to_tsvector(col), to_tsquery(...)) AS alias`).
    FullTextRank {
        col: String,
        query: String,
        config: Option<String>,
